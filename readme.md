...
- **Frontend**: Javascript ES5/ES6, Typescript, React, Redux, MobX, Effector, Next.js, FSD
- **HTML & CSS**: HTML, BEM methodology, CSS, SASS/SCSS, MaterialUI, Ant Design, Bootstrap, Styled Components
- **DB & ORM**: SQL, MySQL, PostgreSQL, Sequelize, Prisma
...
- Fortune Wheel:
  - [code](https://github.com/destiny503/delta-fortune) (freelance project)
